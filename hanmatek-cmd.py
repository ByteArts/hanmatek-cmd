...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--portname', default=power_supply_port, help='set port name', type=str)
    params = vars(parser.parse_args())
    power_supply_port = params['portname']

    print(f'Using port: {power_supply_port}')
